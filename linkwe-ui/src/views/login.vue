...
<!--          >-->
    ...
    <div class="el-login-footer">
      <span>Copyright © 2018-2021 MINCHUANG All Rights Reserved.</span>
    </div>
...
export default {
  ...
  created() {
    ...
    // this.$confirm(
    //   'MINCHUANG V2.0 正式发布公测，遇到使用上的问题欢迎提交 Issue，我们将光速修复。',
    //   '提示',
    //   {
  ...
  methods: {
    ...
    goVote() {
      window.open('https://www.oschina.net/p/michuang')
    },
